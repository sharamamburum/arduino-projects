...
void setup() {
  ...
  //   	time.settime(00,41,22,25,02,16);	// 31, декабря, 2015 года, время и день недели оставить без изменений
...
void loop() {
  if (millis() % 1000 == 0) { // если прошла 1 секунда
    ...
    lcd.print(time.gettime("H:i:s  d.m.Y"));      // go to start of 2nd line
